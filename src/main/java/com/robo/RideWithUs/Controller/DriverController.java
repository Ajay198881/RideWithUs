...
public class DriverController {
	...
	public void UpdateDriverVehicleLocation(@RequestBody UpdateDriverVehicleLocationDTO updatelocation) {
		
		driverService.UpdateDriverVehicleLocation(updatelocation);
	}
}
